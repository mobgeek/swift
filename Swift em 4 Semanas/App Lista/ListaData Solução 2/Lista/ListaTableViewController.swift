...
class ListaTableViewController: UITableViewController,UITableViewDelegate, UITableViewDataSource {
    ...
    func timeSinceDate(date: NSDate) -> String {
        ...
        let unidades: NSCalendarUnit = .CalendarUnitDay | .CalendarUnitHour | .CalendarUnitMinute
        
        let components = calendar.components(unidades, fromDate: startDate, toDate: endDate, options: nil)
