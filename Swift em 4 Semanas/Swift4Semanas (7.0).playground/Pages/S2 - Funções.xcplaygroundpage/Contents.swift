...
func digaOcupado(nomePessoa: String) {
    ...
    print("To ocupado \(nomePessoa). Te ligo mais tarde!")
...
juntar("flamengo", s2: "vasco", comJunção:" x ")


//Usando nome externo identico ao local

func possuiLetra(string string: String, letraEncontrada letraEncontrar: Character) -> Bool {
...
var temA = possuiLetra(string: "Oi Ana!", letraEncontrada: "A")



// Valores Padrão de Parâmetros

func novaJuntar(s1: String, _ s2: String, junção: String = " x ") -> String {
...
func chamarIntensidade(var nome: String, _ intensidade: Int) -> String {
...
func trocaAssento(inout a1: String, inout _ a2: String) {
...
func adicionaInteiros(a: Int, _ b: Int) -> Int    // (Int, Int) -> Int
{
    return a + b
}
...
func resultado(funcaoMatematica: (Int, Int) -> Int, _ a: Int, _ b: Int) -> String
{
