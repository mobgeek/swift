//: [Anterior: Classes, Estruturas e Enums](@previous)
...
class ContaPassos {
    ...
    var totalPassos: Int = 0 {
        ...
        willSet(novoTotalPassos) {
            ...
            print("Prestes a configurar totalPassos para \(novoTotalPassos) ")
        }
        ...
        didSet {
            ...
            if totalPassos > oldValue {
                ...
                print("\(totalPassos - oldValue) passos adicionados!")
...
//Nós não queremos ter que inicializar um Circulo para poder acessar sua constante PI. Outra vantagem de propriedades do tipo é que elas são compartilhadas por todas as instâncias desse tipo. E a propriedade PI pode ser compartilhada por todos os circulos que venham a ser criados na aplicacao.

Circulo.PI


//: [Próximo: Métodos](@next)
