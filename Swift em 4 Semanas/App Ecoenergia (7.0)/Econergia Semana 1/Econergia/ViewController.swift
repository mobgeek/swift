...
class ViewController: UIViewController, UITextFieldDelegate {
    ...
    func textFieldShouldEndEditing(textField: UITextField) -> Bool
    {
        ...
        if let texto = textField.text where texto.isEmpty { return true }
        ...
        case potenciaTextField:
            ...
            if let texto = potenciaTextField.text, value = Int(texto) {
        ...
        case minutosUsoDiarioTextField:
            ...
            if let texto = minutosUsoDiarioTextField.text, value = Int(texto) {
    ...
    func textFieldDidEndEditing(textField: UITextField)
    {
        ...
        if let text1 = potenciaTextField.text, text2 = minutosUsoDiarioTextField.text where !text1.isEmpty && !text2.isEmpty {
