...
func permutaDoisInts(inout a: Int, inout b: Int) {
...
func permutaDoisValores<T>(inout a: T, inout b: T) {
...
func todosOsItensCombinam<C1: Container, C2: Container where C1.TipoItem == C2.TipoItem, C1.TipoItem: Equatable>(umContainer: C1, outroContainer: C2) -> Bool {
